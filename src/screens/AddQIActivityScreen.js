...
import TopMobileMenu from "../utility/TopMobileMenu";

const AddQIActivityScreen = ({ route }) => {
    ...
    const saveReportLocally = async () => {
        try {
            ...
            const reportIssues = { reportId, indicatorNo, issues, date };
    ...
    const submitReport = async () => {
        try {
            ...
            if (connectionInfo.isConnected) {
                ...
                const response = await axios.post(`${localServerAddress}/tbqual/api/aggreport-issue`, {
                    reportId,
                    indicatorNo,
                    issues,
                }, {
...
export default AddQIActivityScreen;
